---
title: 'Exploratory Data Analysis of COVID-19 Cases'
...
```{r epi_ecdc, echo=FALSE, fig.height=80, fig.width=100, message=FALSE, warning=FALSE}
...
(ffx_plot = ggplot(fx_inc) +
    theme_minimal() + 
    geom_col(aes(x = date_rec, y = cases), 
             color = "#053061", fill = "#053061" ) +
    labs(x ="Time (Days)", y = "Cases", 
         title = "Cases of COVID-19 in Fairfax County VA") +
    ylim(0, 20000))
