...
files <- list(ecdc_data = here::here("COVID19/write/input/ecdc_clean.csv"),
              nyt_data = here::here("COVID19/write/input/nyt_clean.csv"),
              
              fairfax = here::here("COVID19/write/output/epicurve_ffaxva.png"),
              stafford = here::here("COVID19/write/output/epicurve_stafva.png"),
              fulton = here::here("COVID19/write/output/epicurve_fultga.png"),
              gwinnett = here::here("COVID19/write/output/epicurve_gwinga.png"),
              manatee = here::here("COVID19/write/output/epicurve_mteefl.png"),
              madison = here::here("COVID19/write/output/epicurve_msonny.png"),
              taylor = here::here("COVID19/write/output/epicurve_taylortx.png"),
              jones = here::here("COVID19/write/output/epicurve_jonestx.png"),
              randolph = here::here("COVID19/write/output/epicurve_randnc.png"))
...
Cases reported by NYT (#FIXME: use state level dataset)

#```{r epi_nyt, fig.height=5, fig.width=5, echo = FALSE}
...
#         freq = "cases",
#         color = "#313695",
#         xlabel=sprintf("From %s to %s", min(nyt_cases$date_rec), max(nyt_cases$date_rec)),
#         note = "Daily epidemic curve from NYT (United States)")
#
#```

Cases reported by NYT in Fairfax County

```{r epi_fair, echo=, fig.height=20, fig.width=25}
...
```{r epi_staff, echo=, fig.height=5, fig.width=10}
...
```{r epi_fult, echo=, fig.height=45, fig.width=50}
...
```{r epi_gwin, echo=, fig.height=25, fig.width=30}
...
```{r epi_mana, echo=, fig.height=10, fig.width=15}
...
```{r epi_madis, echo=, fig.height=5, fig.width=10}
...
```{r epi_tx, echo=, fig.height=5, fig.width=10}
...
```{r epi_rand, echo=, fig.height=5, fig.width=10}
